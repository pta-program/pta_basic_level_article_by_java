...
static FastScanner fs = new FastScanner(System.in);
    ...
    char mode; char[] s = new char[1005];
    mode = fs.next().charAt(0);
    getchar();
    ...
    } else for (int i = 0; i < strlen(s);) {
        int n = 0;
        while (s[i] >= '0' && s[i] <= '9') n = n * 10 + s[i ++] - '0';
        if (n == 0) n = 1;
        while (n-- > 0) putchar(s[i]);
        i ++;
    }
    putchar('\n');
